...
public interface ThaumaturgyBlocks {
    Block INTERCEPTOR = createWithItem("interceptor", InterceptorBlock::new, AbstractBlock.Settings.copy(Blocks.BONE_BLOCK).sounds(BlockSoundGroup.LODESTONE), new Item.Settings());
